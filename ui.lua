...
toggleButton.Position = UDim2.new(0, 10, 0, 10) -- Pojok kiri atas
...
-- Cari UI Utama (ganti kalau nama UI beda)
local mainUI = nil
for _, v in pairs(gui:GetChildren()) do
    if v:IsA("ScreenGui") and string.find(v.Name, "YoxanHub") then
        mainUI = v
        break
    end
end
